...
%%%%%%%%%%%%%
%DO NOT USE THIS DRAFT; IT IS JUST HERE FOR REFERENCE
%%%%%%%%%%
...
\nevereverevercompile
{\bf
DO NOT USE THIS DRAFT IT IS OUT OF DATE
}
...
15,000 of the 97,000 simulated LSST galaxy observations are randomly
...
algorithm.  Initially, 15,000 of our 97,000 simulated LSST galaxy 
observations are
...
We will test our algorithms using both real (as in Figure \ref{subfig:lnsumsdss}) and
