...
\subsection{Fortifying Gaussian Processes against incomplete training
  data}
\label{sec:missing}
...
machine learning algorithms will face (see Section~\ref{sec:missing}.  We will demonstrate our novel
