...
understanding of the spectra being inferred. 
...
observations.  Photometric redshifts are derived using the ANNZ neural
network algorithm in Figure \ref{subfig:annz} and the EAZY template-fitting
algorithm in Figure \ref{subfig:eazy}
}
\label{fig:scatter}
\end{figure}
