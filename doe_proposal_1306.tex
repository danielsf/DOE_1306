...
The framework above provides many advantages when applied to active learning. 
Because Gaussian Processes model the training data as a probability
distribution, the output (specifically, equation \ref{eq:var}) provides a direct
quantification of the information content of the model.  This allows us to
