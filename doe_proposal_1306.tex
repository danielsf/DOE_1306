...
\begin{figure}
\includegraphics[scale=0.3]{doe_desert_plot.png}
\caption{
...
\begin{figure}
\subfigure[]{
\includegraphics[scale=0.25]{becker_RRLyrae_fig.png}
\label{subfig:cadence}
}
\subfigure[]{
\includegraphics[scale=1.0]{becker_RRlyrae_phase.png}
\label{subfig:phase}
}
\caption{
Taken from \cite{rrlyrae}.  Figure \ref{subfig:cadence} shows the sampling of
a template RR Lyrae light curve at the LSST Universal Cadence (left) and 
Deep Drilling Cadence (right).  Figure \ref{subfig:phase} compares the scatter
